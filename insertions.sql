...
INSERT INTO clientes (nome, cidade_id)
VALUES
('João Silva', 1),
('Maria Oliveira', 2),
('Carlos Souza', 3),
...
INSERT INTO pedidos (cliente_id, criado_em, total)
VALUES
...
INSERT INTO itens (pedido_id, produto_id, qtd, preco_unitario)
VALUES
(1, 1, 1, 2500.00),
(1, 2, 1, 1000.00),
(2, 3, 2, 60.00),
...
INSERT INTO transacoes (conta_id, valor, ts)
VALUES
...
INSERT INTO cotacoes (ativo_id, ts, preco)
VALUES
